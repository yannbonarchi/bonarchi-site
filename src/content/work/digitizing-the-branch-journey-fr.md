...
summary: "Le client démarre une transaction depuis son téléphone. Elle arrive pré-remplie dans la bonne file d'agence, déjà reliée aux systèmes core. Le temps d'attente et le temps de traitement ont fortement baissé."
...
J'ai travaillé à connecter le canal à distance au plancher de l'agence. Un client
...
systèmes core de la banque pour la vérification de compte en temps réel. Le
guichetier valide au lieu de ressaisir.

Les parties difficiles étaient les classiques du banking. Intégration d'API
sécurisée avec la plateforme core. Vérification de compte en temps réel.
